                    ...
                    <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                        <form action="/signupp" method="POST">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="password" name="re_password" id="form1Example23"
                                    class="form-control form-control-lg" />
                                    @if    ($errors-> has('re_password'))
                                    <span class="error-message" style="color:red">{{$errors->first('re_password')}}</span>
                                    @endif
                            </div>
                            ...
                            <a href="/signin" class="btn btn-primary btn-lg btn-block">Sign in</a>
                        </form>
                    </div>
                </div>
            </div>
