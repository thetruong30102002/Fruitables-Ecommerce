                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <form action="/add-cart" method="POST">
                            ...
                            <p class="mb-4">Quantity: {{$product->stock_quantity}}</p>
                            ...
                            @endif
                            @if ($product->stock_quantity <= 0)
                                <input class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"
                                    placeholder="Hết Hàng" disabled>
                            @endif
                        </form>
                    </div>
